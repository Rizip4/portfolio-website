Build a Video Editor & Motion Designer portfolio landing page for "Rijip Pokharel" using React, TypeScript, Tailwind CSS, Framer Motion, and Lucide React. The page has a dark theme (#0C0C0C background) with the font Kanit (Google Fonts, weights 300-900). The page title is "Rijip Pokharel -- Video Editor & Motion Designer".
...
[Note: your live site doesn't currently show this nav bar -- keeping it here since it was in the original template. Drop it if you don't want one.]

Hero Heading: Massive h1 with text "Hi, i'm Rijip" (lowercase "i", curly apostrophe via &apos;). Uses the .hero-heading gradient text class. Font-black, uppercase, tracking-tight, leading-none, whitespace-nowrap, w-full. Font sizes: text-[14vw] sm:text-[15vw] md:text-[16vw] lg:text-[17.5vw]. Margin top: mt-6 sm:mt-4 md:-mt-5. Wrapped in overflow-hidden container.

Bottom bar: Flexbox justify-between items-end with pb-7 sm:pb-8 md:pb-10:

Left: paragraph text "a video editor & motion designer crafting compelling stories through dynamic visuals, precise timing, and creative excellence", color #D7E2EA, font-light, uppercase, tracking-wide, leading-snug. Font size: clamp(0.75rem, 1.4vw, 1.5rem). Max-width: max-w-[160px] sm:max-w-[220px] md:max-w-[260px]. [Pulled directly from your site's hero subtext.]
Right: ContactButton component (see below), label updated to "Get in Touch" to match your site's copy.

Hero Portrait: Centered absolutely. Uses a Magnet component (mouse-following magnetic effect) wrapping an image. [Image URL: replace with your own portrait/photo or brand mark -- not available from the live site screenshot.] Magnet settings: padding 150, strength 3, activeTransition "transform 0.3s ease-out", inactiveTransition "transform 0.6s ease-in-out". Positioning: absolute left-1/2 -translate-x-1/2 z-10. Width: w-[280px] sm:w-[360px] md:w-[440px] lg:w-[520px]. On mobile: top-1/2 -translate-y-1/2. On sm+: sm:top-auto sm:translate-y-0 sm:bottom-0.
...
[Replace the 21 GIF URLs below with clips/thumbnails from your own reel -- e.g. stills or short loops from "Car animation," "CGI car added to Real Footage," "Insta VFX Reel," and any other work samples you have. Keep the same count/split so the scroll mechanic below still works.]
...
Four decorative images positioned absolutely in corners: [replace with your own video/motion-themed graphics -- e.g. a camera, film reel, clapperboard, lens flare -- sized and positioned as below. Original asset URLs were 3D-creator specific and don't apply to your work.]

Top-left: w-[120px] sm:w-[160px] md:w-[210px], positioned top-[4%] left-[1%] sm:left-[2%] md:left-[4%]. FadeIn: delay 0.1, x -80, y 0, duration 0.9.
...
Animated paragraph: Uses a character-by-character scroll-driven opacity animation. Text: "With more than six years of experience in video editing and motion design, i focus on cinematic storytelling, vfx compositing, and brand visuals, i truly enjoy working with businesses and creators who want their story told with impact. Let's build something incredible together!" -- color #D7E2EA, font-medium, centered, leading-relaxed, max-w-[560px], font size clamp(1rem, 2vw, 1.35rem). Each character animates from opacity 0.2 to 1 based on scroll progress, with scroll offset ['start 0.8', 'end 0.2']. [Years-of-experience and skill focus pulled from your site's stats card and tools list.]
...
Heading: "Skills & Tools" in #0C0C0C, font-black, uppercase, centered, font size clamp(3rem, 12vw, 160px). Margin bottom: mb-16 sm:mb-20 md:mb-28.

6 service items in a vertical list, max-w-5xl, centered [expanded from 5 to 6 to match your real tools list]:

01 - VFX: "Visual effects compositing that blends CGI, live footage, and practical elements into one seamless shot."
02 - After Effects: "Motion graphics, tracking, and animated title work that adds energy and polish to every frame."
03 - Premiere Pro: "Narrative editing, pacing, and final assembly that turns raw footage into a compelling story."
04 - Compositing: "Layering visual elements together with precise color and light matching for a believable final image."
05 - Motion Design: "Kinetic typography and animated brand assets that bring products and stories to life."
06 - Blender: "3D modeling and rendering for CGI elements dropped seamlessly into real footage."
...
Heading: "Featured Projects" using .hero-heading gradient, same styling as other headings.

5 sticky-stacking project cards that scale down as you scroll past them (card stacking effect using Framer Motion useScroll and useTransform) [expanded from 3 to 5 to match your real project list]. Each card is sticky top-24 md:top-32 inside an h-[85vh] container.
...
[Replace the placeholder image URLs below with your own project stills/thumbnails.]

Project 01 - "Car animation" (Category: CGI):

Col1 image 1: [placeholder -- your still/thumbnail]
Col1 image 2: [placeholder -- your still/thumbnail]
Col2 image: [placeholder -- your still/thumbnail]

Project 02 - "CGI car added to Real Footage" (Category: CGI and VFX):

Description line under project name: "3D Tracked Scene, Added CGI toy car & Composited inside After Effects"
"Live Project" button replaced with "Watch on YouTube" button, linking out to the video. [placeholder -- your YouTube URL]
Col1 image 1: [placeholder -- your still/thumbnail]
Col1 image 2: [placeholder -- your still/thumbnail]
Col2 image: [placeholder -- your still/thumbnail]

Project 03 - "Board Manage" (Category: SaaS):

Col1 image 1: [placeholder -- your still/thumbnail]
Col1 image 2: [placeholder -- your still/thumbnail]
Col2 image: [placeholder -- your still/thumbnail]

Project 04 - "Insta VFX Reel" (Category: Reel):

Col1 image 1: [placeholder -- your still/thumbnail]
Col1 image 2: [placeholder -- your still/thumbnail]
Col2 image: [placeholder -- your still/thumbnail]

Project 05 - "Flight Book" (Category: SaaS):
...
REUSABLE COMPONENTS
ContactButton: Rounded-full pill button with gradient background linear-gradient(123deg, #18011F 7%, #B600A8 37%, #7621B0 72%, #BE4C00 100%), inner box-shadow 0px 4px 4px rgba(181, 1, 167, 0.25), 4px 4px 12px #7721B1 inset, white 2px outline with -3px offset. Text: white, font-medium, uppercase, tracking-widest. Sizes: px-8 py-3 sm:px-10 sm:py-3.5 md:px-12 md:py-4, text text-xs sm:text-sm md:text-base. Label: "Get in Touch" (hero/about) or "Start a Project" (used again at the very end of the page, if you add a closing CTA).

LiveProjectButton: Ghost/outline pill button. Rounded-full, border-2 border-[#D7E2EA], text color #D7E2EA, font-medium, uppercase, tracking-widest. Sizes: px-8 py-3 sm:px-10 sm:py-3.5, text text-sm sm:text-base. Hover: bg-[#D7E2EA]/10. Label: "Live Project" (or "Watch on YouTube" for the video project card).
